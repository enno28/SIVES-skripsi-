...
<p>
  <button class="btn btn-success btn-sm" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
    Unggah Berkas Verifikasi
  </button>
</p>
@include('flash::message')
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    <form class="form-horizontal" action="{{ route('berkas_verifikasi.store') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
          ...
          <div class="form-group col-sm-6">
            <label for="berkas_verifikasi">File Verifikasi</label>
              <input type="file" name="berkas_verifikasi" class="form-control" id="berkas_verifikasi" required="">
          </div>
...
<div class="card mb-3" style="margin-top: 15px">
  <div class="card-header">
      <i class="fa fa-table"></i> Daftar Berkas Verifikasi
    </div>
  <div class="card-body">
