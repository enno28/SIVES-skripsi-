                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <button 
                                              ...
                                              data-pengajar ="{{$unggah->mata_kuliah->users}}"
                                            ...
                                            <form method="GET" action="{{ url('download_admin')}}" style="display: inline;">
                                              {{ csrf_field() }}
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <table class="table table-bordered dataTableClass" cellspacing="0">
                                    ...
                                    @php
                                      $counter = 1;
                                    @endphp
                                    @foreach( $verifikasi as $key => $unggah)
                                      @foreach($unggah->mata_kuliah->verifikasi as $soal)
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('pdf_admin',$soal->versi_soal[$ind]->id_versi)}}"><button type="button" class="btn btn-success btn-sm">Hasil Verif</button>
                                            </a>
                                        </td>
                                      </tr>
                                      @endif
