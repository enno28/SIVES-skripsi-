...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    <form class="form-horizontal" action="{{ route('bap.store') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
          ...
          <div class="form-group col-sm-6">
            <label for="berkas_bap">File BAP</label>
              <input type="file" name="berkas_bap" class="form-control" id="berkas_bap" required="">
          </div>
...
<div class="card mb-3" style="margin-top: 15px">
  <div class="card-header">
      <i class="fa fa-table"></i> Daftar Berkas Berita Acara Pengajaran (BAP)
    </div>
  <div class="card-body">
