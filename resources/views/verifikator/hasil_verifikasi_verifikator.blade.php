                                    ...
                                    @foreach( $matkul as $mk)
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="GET" action="{{ url('download2')}}" style="display: inline;">
                                              {{ csrf_field() }}
                                    ...
                                    @foreach( $dosen as $key => $unggah)
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('pdf2',$soal->versi_soal[$ind]->id_versi)}}"><button type="button" class="btn btn-success btn-sm">Hasil Verif</button>
                                            </a>
...
<div class="modal fade" id="revisi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" action="{{ url('store_revisi_verifikator') }}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
